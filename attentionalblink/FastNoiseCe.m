function FastNoiseCe(numRects, RectSize1, RectSize2, scale, syncToVBL, dur_time, dontclear, mywin, winrect, hertz)
...
%     [win, winRect] = Screen('OpenWindow', screenid, 128);
    ...
    objRect = SetRect(0,0, RectSize1, RectSize2);
...
%     while vbl < (tstart + 10)
    ...
    while  count < (hertz*dur_time)  %vbl <(tstart + dur_time)%
        ...
        for i=1:numRects
            ...
            noiseimg=(50*randn(RectSize1, RectSize2) + 128);

            % Convert it to a texture 'tex':
            tex=Screen('MakeTexture', mywin, noiseimg);
            ...
            Screen('DrawTexture', mywin, tex, [], dstRect(i,:), [], 0);
        ...
        Screen('Flip', mywin, 0, dontclear, asyncflag);
